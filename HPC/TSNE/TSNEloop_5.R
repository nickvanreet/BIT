...
generate_filename <- function(perplexity, learning_rate) {
  return(paste0('tsne_results_CN_5_perplexity_', perplexity, '_lr_', learning_rate, '.csv'))
}
...
tsne <- read_csv("tsne_results_CN_5_perplexity_10_lr_200.csv")
...
number_of_clusters <- 6  # Replace with the number of clusters you expect or determined
