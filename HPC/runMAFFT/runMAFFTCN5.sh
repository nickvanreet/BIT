...
MAFFT_input="//scratch/antwerpen/206/vsc20643/TBRhunt/UNIQUE/CN_5/unique_sequences_CN5.fasta"
MAFFT_output="/scratch/antwerpen/206/vsc20643/TBRhunt/MAFFT/"
MAFFT_output_aln="${MAFFT_output}/aligned_unique_sequences_CN5.fasta"
